    ...
    <div className="flex flex-col w-full">
      ...
      <footer className="text-xs p-4 w-full flex justify-center">
        <div className="max-w-4xl text-center text-muted-foreground leading-relaxed">
          Developed by Prof. Dr. Hilde De Weerdt, Dr. Rainer Simon, Dawn Zhuang, Dr. Lee 
          Sunkyu, Dr. Iva Stojević, Meret Meister, and Xi Wangzhi with funding from the 
          European Research Council under the Horizon 2020 programme, grant agreement 
          No. 101019509.
        </div>
      </footer>
    </div>
