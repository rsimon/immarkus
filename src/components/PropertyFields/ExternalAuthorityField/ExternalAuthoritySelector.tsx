    ...
    <>
     {authorities.length === 1 ? (
        <button 
          ...
          className="text-xs flex items-center hover:bg-slate-200 px-1.5 py-0.5 rounded focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-0">
        ...
        <Select 
          ...
          <div 
            ...
            <button 
              ...
              className="text-xs flex items-center hover:bg-slate-200 px-1.5 py-1 pr-1.5 rounded 
            ...
            <SelectTrigger
              className="border-none -ml-0.5 pr-1.5 pl-0.5 py-1 bg-transparent hover:bg-slate-200 focus:outline-none focus:ring-0 
